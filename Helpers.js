...
function initHelpers(w, d, undefined) {
  ...
  function setDateTimeFormat() {
    if (d.querySelector('#dtfloaded')) {
      return true;
    }
    var dtf  = createElementWithProps( 'script',
                                       { src: 'https://rawgit.com/KooiInc/Helpers/master/DTFormat.js',
                                          id: 'dtfloaded' } );
    return d.querySelector('head').appendChild(dtf);
  }
